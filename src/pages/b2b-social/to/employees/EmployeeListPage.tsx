...
const sampleEmployees: Employee[] = [
  { id: 'e1', name: '김철수', email: 'cskim@company.com', department: '개발팀', position: '팀원', rank: '대리', jobRole: '백엔드 개발', joinDate: new Date('2022-03-15'), status: 'active' },
  { id: 'e2', name: '이영희', email: 'yhlee@company.com', department: '개발팀', position: '팀원', rank: '과장', jobRole: '프론트엔드 개발', joinDate: new Date('2020-08-01'), status: 'active' },
  { id: 'e3', name: '박지민', email: 'jmpark@company.com', department: '마케팅팀', position: '팀장', rank: '차장', jobRole: '마케팅 기획', joinDate: new Date('2019-01-10'), status: 'active' },
