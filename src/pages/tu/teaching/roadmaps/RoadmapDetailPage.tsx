...
const t = {
  ...
  programCount: { ko: '과정 수', en: 'Programs' },
  createdAt: { ko: '생성일', en: 'Created' },
  updatedAt: { ko: '최근 수정', en: 'Last Updated' },
  programList: { ko: '과정 목록', en: 'Program List' },
  noPrograms: { ko: '등록된 과정이 없습니다', en: 'No programs added' },
  noProgramsDesc: { ko: '로드맵을 수정하여 과정을 추가하세요', en: 'Edit the roadmap to add programs' },
