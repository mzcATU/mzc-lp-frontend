...
import { useInstructorAssignments, useAssignInstructor } from '@/hooks/co/useInstructorAssignmentQueries';
import { useTimesInfinite, useTime } from '@/hooks/co/useTimeQueries';
import { useUsersInfinite } from '@/hooks/co/useUserQueries';
import type {
    ...
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-40">
          <DropdownMenuItem
            onClick={() => item.courseTime?.id && navigate(prefixPath(`/co/times/${item.courseTime.id}`))}
                ...
                <button
                  onClick={() => {
                    if (selectedAssignment.courseTime?.id) {
                      navigate(prefixPath(`/co/times/${selectedAssignment.courseTime.id}`));
                    }
                  }}
