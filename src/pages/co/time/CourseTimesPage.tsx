...
import { useTimes, useDeleteTime, useOpenTime } from '@/hooks/co/useTimeQueries';
import type {
  CourseTimeResponse,
  CourseTimeStatus,
    ...
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-40">
          <DropdownMenuItem onClick={() => navigate(prefixPath(`/co/times/${item.id}`))}>
            <Eye size={14} />
            {getText('view')}
          </DropdownMenuItem>
      ...
      <div className="sticky top-0 z-10 bg-bg-app">
        <div className="p-6 px-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button onClick={() => navigate(prefixPath('/co/times/create'))}>
              <Plus size={20} />
        ...
        <div className="p-6 px-8 pt-0">
          ...
          {!isLoading && filteredTimes.length > 0 && (
            <DataTable
              ...
              onRowClick={(item) => navigate(prefixPath(`/co/times/${item.id}`))}
              labels={{
