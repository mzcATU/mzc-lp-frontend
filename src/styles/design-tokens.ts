...
export const designTokens = {
  ...
  // --- Text and Typography ---
  text: {
    primary: '#333333',           // 핵심 텍스트
    secondary: '#666666',         // 보조 텍스트/아이콘
    placeholder: '#999999',       // 플레이스홀더
    on_brand_active: '#4C2D9A',   // 활성 배경 위 텍스트/아이콘 (Brand Primary)
  ...
  action: {
    ...
    delete_text: '#F44336',       // 삭제/위험 액션 텍스트
  },
  ...
  button: {
    ...
    neutral_hover: '#3D3D3D',         // 뉴트럴 버튼 호버
    neutral_text: '#FFFFFF',          // 뉴트럴 버튼 텍스트

    // Brand 버튼 (브랜드 액션)
    brand_default: '#4C2D9A',         // 브랜드 버튼 기본
    brand_hover: '#3D2478',           // 브랜드 버튼 호버
    brand_text: '#FFFFFF',            // 브랜드 버튼 텍스트
  },

  // --- Status/Semantic Colors (Chips/Badges) ---
  status: {
    success_text: '#388E3C',           // Success 뱃지 텍스트
    success_background: '#D4EDDA',     // Success 뱃지 배경
    warning_text: '#FFA000',           // Warning 뱃지 텍스트
    warning_background: '#FFF3CD',     // Warning 뱃지 배경
    error_text: '#D32F2F',             // Error 뱃지 텍스트
